    ...
    def generate_molecule(self,M,**kwargs):
        ...
        if mname in self.cfg.use_sea:
            ...
            if len(M.sequence)==1: # this is a monomer, but not symmetric
                M.TopoCoord.set_gro_attribute('sea-idx',0)
    ...
    def CURE(self):
        ...
        while not CP.state==CPstate.post_cure:
            ...
            if CP.state==CPstate.bondsearch:
                ...
                if dragging: # refers to simulations in which atoms to be bonded are dragged towards
                             # each other before making the actual bonds
